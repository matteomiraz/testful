...
public class BytecodeUtils {
	...
	public static String getBytecodeName(final XmlParameter type) {
		if(type.getType().equals("void"))	return (type.isArray() ? "[" : "") + "V";
		if(type.getType().equals("boolean")) return (type.isArray() ? "[" : "") + "Z";
		if(type.getType().equals("char")) return (type.isArray() ? "[" : "") + "C";
		if(type.getType().equals("byte")) return (type.isArray() ? "[" : "") + "B";
		if(type.getType().equals("short")) return (type.isArray() ? "[" : "") + "S";
		if(type.getType().equals("int")) return (type.isArray() ? "[" : "") + "I";
		if(type.getType().equals("float")) return (type.isArray() ? "[" : "") + "F";
		if(type.getType().equals("long")) return (type.isArray() ? "[" : "") + "J";
		if(type.getType().equals("double")) return (type.isArray() ? "[" : "") + "D";

		return (type.isArray() ? "[" : "") + "L" + type.getType() + ";";
	}
