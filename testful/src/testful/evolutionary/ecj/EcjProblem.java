...
public class EcjProblem extends FutureProblem implements SimpleProblemForm {
	...
	public static final String FITNESS_DU = "du";
	...
	public void setup(final EvolutionState state, final Parameter base) {
		...
		boolean fitness_len = false, fitness_bug = false, fitness_bbd = false, fitness_bbn = false, fitness_brd = false, fitness_brn = false, fitness_du = false;
		...
		for(String o : obj.split(":"))
			...
			else if(FITNESS_DU.equals(o)) fitness_du = true;
