...
public class EcjProblem extends FutureProblem implements SimpleProblemForm {
	...
	public static final String FITNESS_BEH = "beh";
	...
	public void setup(final EvolutionState state, final Parameter base) {
		...
		boolean fitness_len = false, fitness_beh = false, fitness_bug = false, fitness_bbd = false, fitness_bbn = false, fitness_brd = false, fitness_brn = false;
		...
		for(String o : obj.split(":"))
			...
			else if(FITNESS_BEH.equals(o)) fitness_beh = true;
		...
		try {
			...
			config.fitness.beh = fitness_beh;
