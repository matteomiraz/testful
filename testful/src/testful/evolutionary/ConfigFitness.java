...
public class ConfigFitness implements IConfigFitness, IConfigFitness.Args4j {
	...
	/*
	 * (non-Javadoc)
	 * @see testful.evolutionary.IConfigFitness#isBeh()
	 */
	@Override
	public boolean isBeh() {
		return beh;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see testful.evolutionary.IConfigFitness.Args4j#setDisableBehavior(boolean)
	 */
	@Override
	public void setDisableBehavior(boolean disable) {
		if(disable) {
			beh = false;
		}
	}
