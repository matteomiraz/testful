...
public class Launcher {
	...
	@Option(required = false, name = "-disableDefUse", usage = "Removes the def-use pairs coverage from the multi-objective fitness (shortcut for -disableDefUseCode and -disableDefUseContract)")
	private boolean disableDefUse = false;
	...
	public static void main(String[] args) throws TestfulException, JMException, SecurityException, IOException {
		...
		config.fitness.du = !opt.disableDefUse;
		...
		algorithm.setInherit(opt.fitnessInheritanceUniform);
