...
public class TestCoverageFaultCUT extends SingleTestCUT {
	...
	public TestCoverageFaultCUT() throws Exception {
		...
		assertEquals("__testful_get_defs__()", cut.getMethods()[0].toString());
		assertEquals("__testful_get_fields__()", cut.getMethods()[1].toString());
		assertEquals("a(java.lang.Object)", (a = cut.getMethods()[2]).toString());
		assertEquals("a1(java.lang.Object)", (a1 = cut.getMethods()[3]).toString());
		assertEquals("a2(java.lang.Object)", (a2 = cut.getMethods()[4]).toString());
		assertEquals("b()", (b = cut.getMethods()[5]).toString());
		assertEquals("b1()", (b1 = cut.getMethods()[6]).toString());
		assertEquals("c()", (c = cut.getMethods()[7]).toString());
		assertEquals("c1()", (c1 = cut.getMethods()[8]).toString());
		assertEquals("c2()", (c2 = cut.getMethods()[9]).toString());
		assertEquals("d()", (d = cut.getMethods()[10]).toString());
		assertEquals("e()", (e = cut.getMethods()[11]).toString());
		assertEquals("e1()", (e1 = cut.getMethods()[12]).toString());
		assertEquals("f()", (f = cut.getMethods()[13]).toString());
		assertEquals("f1()", (f1 = cut.getMethods()[14]).toString());
		assertEquals("f2()", (f2 = cut.getMethods()[15]).toString());
		assertEquals("f3()", (f3 = cut.getMethods()[16]).toString());
		assertEquals("f4()", (f4 = cut.getMethods()[17]).toString());
		assertEquals("g()", (g = cut.getMethods()[18]).toString());
		assertEquals("g1()", (g1 = cut.getMethods()[19]).toString());
