 ...
 */
public class FractionNoStatic extends Number implements Serializable {
	...
	public FractionNoStatic(double value) throws ArithmeticException {
	...
	//@ signals (ArithmeticException e) true;
	public FractionNoStatic(double value, double epsilon, int maxIterations) throws ArithmeticException {
	...
	/*@ requires maxDenominator > 1;
      ...
      @ signals (ArithmeticException e) true;
      @*/
	public FractionNoStatic(double value, int maxDenominator) throws ArithmeticException {
	 ...
	 *         converge.
	 */
	private FractionNoStatic(double value, double epsilon,
			int maxDenominator,
	...
	public FractionNoStatic(int num) {
		this(num, 1);
	}
	...
	public FractionNoStatic(int num, int den) {
		if(den == 0)  {
	...
	public FractionNoStatic abs() {
		FractionNoStatic ret;
		if (numerator >= 0) {
			ret = this;
		} else {
			ret = negate();
	...
	public int compareTo(FractionNoStatic object) {
	 ...
	 *         <tt>null</tt>, not an instance of {@link FractionNoStatic}, or not equal
	...
	public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object other) {
		...
		if (this == other) {
			...
			if(!(other instanceof FractionNoStatic)) ret = false;
			else {
				// since fractions are always in lowest terms, numerators and
				// denominators can be compared directly for equality.
				FractionNoStatic rhs = (FractionNoStatic)other;
	...
	//@signals (ArithmeticException e) this.getNumerator() == Integer.MIN_VALUE;
	public FractionNoStatic negate() {
		if (numerator==Integer.MIN_VALUE) {
			throw new ArithmeticException("overflow: too large to negate");
		}
		return new FractionNoStatic(-numerator, denominator);
	}
	...
	public FractionNoStatic reciprocal() {
		return new FractionNoStatic(denominator, numerator);
	}
	...
	//@signals (ArithmeticException e) true;
	public FractionNoStatic add(FractionNoStatic fraction) {
	...
	//@signals (ArithmeticException e) true;
	public FractionNoStatic add(final int i) {
		return new FractionNoStatic(addAndCheck(numerator, mulAndCheck(i, denominator)), denominator);
	}
	...
	//@signals (IllegalArgumentException e) fraction == null;
	//@signals (ArithmeticException e) true;
	public FractionNoStatic subtract(FractionNoStatic fraction) {
	...
	//@ensures testful.JMLUtils.doubleCheck(\result.doubleValue(), this.doubleValue() - i, eps);
	//@signals (ArithmeticException e) true;
	public FractionNoStatic subtract(final int i) {
		return new FractionNoStatic(subAndCheck(numerator, mulAndCheck(i, denominator)), denominator);
	}
	 ...
	 *   cannot be represented in an <code>int</code>.
	 */
	private FractionNoStatic addSub(FractionNoStatic fraction, boolean isAdd) {
		if (fraction == null) {
		...
		return new FractionNoStatic (w.intValue(),
	...
	//@signals (IllegalArgumentException e) fraction == null;
	//@signals (ArithmeticException e) true;
	public FractionNoStatic multiply(FractionNoStatic fraction) {
		if (fraction == null) {
			throw new IllegalArgumentException("The fraction must not be null");
		}
		if (numerator == 0 || fraction.numerator == 0) {
			return new FractionNoStatic(0, 1); // was: ZERO
		}
		// knuth 4.5.1
	...
	//@ensures testful.JMLUtils.doubleCheck(\result.doubleValue(), this.doubleValue() * i, eps);
	//@signals (ArithmeticException e) true;
	public FractionNoStatic multiply(final int i) {
		return new FractionNoStatic(mulAndCheck(numerator, i), denominator);
	}
	...
	//@signals (IllegalArgumentException e) fraction == null;
	//@signals (ArithmeticException e) true;
	public FractionNoStatic divide(FractionNoStatic fraction) {
		if (fraction == null) {
			throw new IllegalArgumentException("The fraction must not be null");
		}
	...
	//@ensures testful.JMLUtils.doubleCheck(\result.doubleValue(), this.doubleValue() / i, eps);
	//@signals (ArithmeticException e) true;
	public FractionNoStatic divide(final int i) {
		return new FractionNoStatic(numerator, mulAndCheck(denominator, i));
	}
	 ...
	 */
	private static FractionNoStatic getReducedFraction(int numerator, int denominator) {
		if (denominator == 0) {
			throw new ArithmeticException("The denominator must not be zero");
		}
		if (numerator==0) {
			return new FractionNoStatic(0, 1); // was ZERO; // normalize zero.
		}
